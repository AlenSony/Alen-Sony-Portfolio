...
const appCss = "/assets/styles-DpSl3x-Q.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Portfolio of a full-stack & systems engineer. Web systems, scrapers, network protocols, local AI."
      },
...
const $$splitComponentImporter = () => import("./index-DpqL9u72.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio of Alen Sony, full-stack & systems engineer. Scalable web systems, scrapers, network protocols in C, and local computer vision."
    }, {
      property: "og:title",
      content: "Alen Sony — Full-Stack & Systems Engineer"
    }, {
      property: "og:description",
      content: "Scalable web systems, scrapers, network protocols, and local AI. Built in the dark."
    }]
  }),
